...
public class Dropbox {
    ...
    private DbxEntry.WithChildren files;
    private String previousFolderHash;
    ...
    public void downloadFile(String path) throws IOException, DbxException {
    ...
    public void addFiletoList(File file){
        ...
        dummy.setdata_name(file.getName());
